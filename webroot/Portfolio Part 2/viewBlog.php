...
<?php
    ...
    function SeparateByMonthJan(){
        ...
        $sql = "SELECT * FROM `blog-posts` WHERE Date_Time LIKE '%January%'  ";
        $result = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($result);
        while($row=mysqli_fetch_array($result))
        {   
    ...
    function SeparateByMonthFeb(){
        ...
        $sql = "SELECT * FROM `blog-posts` WHERE Date_Time LIKE '%February%'  ";
        $result = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($result);
    ...
    function SeparateByMonthMar(){
        ...
        $sql = "SELECT * FROM `blog-posts` WHERE Date_Time LIKE '%March%'  ";
        $result = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($result);
        while($row2=mysqli_fetch_array($result))
        {   
    ...
    function SeparateByMonthApril(){
        ...
        $sql = "SELECT * FROM `blog-posts` WHERE Date_Time LIKE '%April%'  ";
        $result = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($result);
        while($row=mysqli_fetch_array($result))
        {   
    ...
    function SeparateByMonthMay(){
        ...
        $sql = "SELECT * FROM `blog-posts` WHERE Date_Time LIKE '%May%'  ";
        $result = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($result);
        while($row2=mysqli_fetch_array($result))
        {   
    ...
    function SeparateByMonthJune(){
        ...
        $sql = "SELECT * FROM `blog-posts` WHERE Date_Time LIKE '%June%'  ";
        $result = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($result);
        while($row2=mysqli_fetch_array($result))
        {   
    ...
    function SeparateByMonthJuly(){
        ...
        $sql = "SELECT * FROM `blog-posts` WHERE Date_Time LIKE '%July%'  ";
        $result = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($result);
        while($row2=mysqli_fetch_array($result))
        {   
    ...
    function SeparateByMonthAug(){
        ...
        $sql = "SELECT * FROM `blog-posts` WHERE Date_Time LIKE '%August%'  ";
        $result = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($result);
        while($row2=mysqli_fetch_array($result))
        {   
    ...
    function SeparateByMonthSep(){
        ...
        $sql = "SELECT * FROM `blog-posts` WHERE Date_Time LIKE '%September%'  ";
        $result = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($result);
        while($row2=mysqli_fetch_array($result))
        {   
    ...
    function SeparateByMonthOct(){
        ...
        $sql = "SELECT * FROM `blog-posts` WHERE Date_Time LIKE '%October%'  ";
        $result = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($result);
        while($row2=mysqli_fetch_array($result))
        {   
    ...
    function SeparateByMonthNov(){
        ...
        $sql = "SELECT * FROM `blog-posts` WHERE Date_Time LIKE '%November%'  ";
        $result = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($result);
        while($row2=mysqli_fetch_array($result))
        {   
    ...
    function SeparateByMonthDec(){
        ...
        $sql = "SELECT * FROM `blog-posts` WHERE Date_Time LIKE '%December%'  ";
        $result = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($result);
        while($row2=mysqli_fetch_array($result))
        {   
